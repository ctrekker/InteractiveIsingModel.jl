...
precompile(Tuple{Type{Observables.Observable{T} where T}, Float64})
precompile(Tuple{Type{NamedTuple{(:title, :resolution), T} where T<:Tuple}, Tuple{String, Tuple{Int64, Int64}}})
precompile(Tuple{typeof(Core.kwcall), NamedTuple{(:title, :resolution), Tuple{String, Tuple{Int64, Int64}}}, Type{Makie.Figure}})
...
precompile(Tuple{typeof(Main.random_spin_lattice), Int64, Int64})
precompile(Tuple{Type{Observables.Observable{T} where T}, Array{Int64, 2}})
...
precompile(Tuple{typeof(Core.kwcall), NamedTuple{(:tellwidth,), Tuple{Bool}}, Type{GridLayoutBase.GridLayout}, GridLayoutBase.GridPosition})
...
precompile(Tuple{typeof(Base.getindex), GridLayoutBase.GridLayout, Int64, Int64})
precompile(Tuple{Type{NamedTuple{(:label,), T} where T<:Tuple}, Tuple{String}})
precompile(Tuple{typeof(Core.kwcall), NamedTuple{(:label,), Tuple{String}}, Type{Makie.Button}, GridLayoutBase.GridPosition})
...
precompile(Tuple{Type{NamedTuple{(:label, :range, :startvalue, :format), T} where T<:Tuple}, Tuple{String, Base.StepRangeLen{Float64, Base.TwicePrecision{Float64}, Base.TwicePrecision{Float64}, Int64}, Int64, String}})
...
precompile(Tuple{Type{Makie.SliderGrid}, GridLayoutBase.GridPosition, Vararg{Any}})
precompile(Tuple{Makie.var"##_#1168", Base.Pairs{Symbol, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, Type{Makie.SliderGrid}, GridLayoutBase.GridPosition, Vararg{Any}})
precompile(Tuple{typeof(Makie._block), Type{Makie.SliderGrid}, GridLayoutBase.GridPosition, NamedTuple{(:label, :range, :startvalue, :format), Tuple{String, Base.StepRangeLen{Float64, Base.TwicePrecision{Float64}, Base.TwicePrecision{Float64}, Int64}, Int64, String}}, Vararg{Any}})
...
precompile(Tuple{Main.var"#15#16", Int64})
...
precompile(Tuple{Main.var"#11#12", Float64})
...
precompile(Tuple{Main.var"#5#6", Int64})
precompile(Tuple{Main.var"#7#9", Int64})
precompile(Tuple{Main.var"#8#10"})
precompile(Tuple{typeof(Base.getindex), Observables.Observable{Array{Int64, 2}}})
precompile(Tuple{typeof(Base.getindex), Observables.Observable{Float64}})
precompile(Tuple{typeof(Main.metropolis_step!), Array{Int64, 2}, Float64, Float64})
precompile(Tuple{typeof(Main.do_reset), Int64})
precompile(Tuple{typeof(Makie.closest_fractionindex), Base.UnitRange{Int64}, Float32})
precompile(Tuple{Main.var"#17#18", Int64})
precompile(Tuple{Main.var"#13#14", Float64})
precompile(Tuple{GLMakie.var"#windowclose#150"{Observables.Observable{Bool}}, GLFW.Window})
precompile(Tuple{typeof(Makie.rootparent), MakieCore.Combined{MakieCore.poly, Tuple{Array{GeometryBasics.Point{2, Float64}, 1}}}})
